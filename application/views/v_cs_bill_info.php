              ...
              <div class="card-footer pt-0 pb-4 d-grid gap-3 ">
                <?php if ($bill->status === 'UNPAID') : ?>
                  <div class="alert alert-danger">
                    <strong>Perhatian:</strong> Tagihan ini belum dibayar. Silakan lakukan pembayaran melalui <strong>agen resmi</strong> atau <strong>kantor PLN terdekat</strong>.
                  </div>
                <?php elseif ($bill->status === 'PROCESSED') : ?>
                  <div class="alert alert-info">
                    Pembayaran Anda sedang diproses oleh petugas. Mohon tunggu konfirmasi.
                  </div>
                <?php elseif ($bill->status === 'PAID') : ?>
                  <div class="alert alert-success">
                    Tagihan ini telah dibayar. Terima kasih atas pembayaran Anda.
                  </div>
                <?php endif; ?>
              </div>
            </div>
