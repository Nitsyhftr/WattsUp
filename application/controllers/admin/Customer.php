...
class Customer extends CI_Controller
{
  ...
  public function index()
  {
    ...
    // Ambil parameter pencarian dan filter daya
    $keyword = $this->input->get('search');
    $daya = $this->input->get('daya');

    // Ambil daftar daya statik
    $data['daftar_daya'] = ['450VA', '900VA', '1300VA', '1500VA', '2200VA', '3500VA', '6600VA'];

    // Ambil data pelanggan hasil filter dari model
    $data['customers'] = $this->M_customer->get_filtered_customers($keyword, $daya);
