...
class UsageCustomer extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $data['usages'] = $this->M_usage->get_filtered_penggunaan_pelanggan($user_auth->id_pelanggan);
    // Kirim juga filter ke view agar form tetap menampilkan nilai input sebelumnya
    $data['search'] = $search;
    $data['bulan'] = $bulan;
    $data['tahun'] = $tahun;
    ...
    $this->load->helper('csmr_auth_helper');
  }
  ...
  public function create()
  {
    ...
    $count_cs_usage = array_filter($this->M_usage->get_filtered_usage(["penggunaan.id_pelanggan" => $customer->id_pelanggan]), fn ($val) => ($val->bulan != intval($month) || $val->tahun != $year));
