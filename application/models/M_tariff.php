...
class M_tariff extends CI_Model
{
  ...
  public function get_tariffs($keyword = null, $order = 'daya', $direction = 'ASC')
{
  if (!empty($keyword)) {
    $this->db->like('daya', $keyword); // bisa diperluas ke tarif_perkwh
    $this->db->or_like('tarif_perkwh', $keyword);
  }
